...
public class Example2Controller {
	...
	// Primera forma parametros con conector "?"
	//http://localhost:8080/example2/request1?nm=JON
	//http://localhost:8080/example2/request1?nm=MIKEL
	@GetMapping("/request1")
	...
	// Segunda forma parametros con conector "/" sin la variable
	//http://localhost:8080/example2/request2/JON
	//http://localhost:8080/example2/request2/MIKEL
